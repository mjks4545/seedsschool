            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" data-toggle="validator"
                          action="<?= site_url() ?>teacher/submit_student_attendance/<?= $result[0]->co_id;?>/<?= $result[0]->fkclass_id;?>"
                          method="post">
                        <?php } ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="form-group has-feedback">
                                                    <select name="status_<?php echo $sno; ?>" class="form-control" required>
                                            ...
                                            <td>  
                                            <div class="checkbox">
                                             <label><input type="checkbox" value="done" name="homework_<?php echo $sno; ?>">Home work</label>
                                            </div>
                                              
                                            </td>
                                            <input type="hidden" name="total_num" value="<?php echo $sno;?>" />
                        ...
                        <?php }else{ ?>
                           ...
                           redirect('teacher/take_teacher_attendance'); }?>
