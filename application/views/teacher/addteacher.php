                         ...
                         <div class="box-body">
                             <div class="col-md-12">
                                 ...
                                 <div class="form-group has-feedback col-md-6">
                                     ...
                                     <input type="text" name="cnic"    class="form-control" id="exampleInputEmail1" placeholder="Enter CNIC Number" required />
                                     <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 20px;"></span>
                                     <span class="help-block with-errors" style="margin-left:10px; "></span>
                                 </div>
                             </div>
                             <div class="col-md-12">
                                <div class="form-group has-feedback col-md-6">
                                     ...
                                     <input type="text" name="address"  class="form-control" minlength="1" maxlength="100" id="exampleInputEmail1" placeholder="Enter Address" required />
                                     <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 20px;"></span>
                                     <span class="help-block with-errors" style="margin-left:10px; "></span>
                                 </div>
								 <div class="form-group has-feedback col-md-6">
                             ...
                             <div class="col-md-12">
                                 <div class="form-group has-feedback col-md-6">
                                     ...
                                     <input type="email" name="email" class="form-control" minlength="1" maxlength="50" id="exampleInputEmail1" placeholder="Email" required />
                                     <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 20px;"></span>
                                     <span class="help-block with-errors" style="margin-left:10px; "></span>
                                 </div>
                                 <div class="form-group has-feedback col-md-6">
