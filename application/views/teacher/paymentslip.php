        ...
        <section class="invoice">
           ...
           <div class="row no-print">
                <div class="col-xs-12">
                    ...
                    <a href="<?php echo site_url() ?>teacher/paymentdetails/<?php echo $paymentdetail['arr']['fkteacher_id'];  ?>" target="_blank" class="btn btn-success pull-right"><i class="fa fa-chevron-circle-left" aria-hidden="true"></i>
                         Back</a>
                </div>
            </div>
        </section><!-- /.content -->
