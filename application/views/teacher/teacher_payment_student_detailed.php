            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    ...
                    <h2 class="page-header text-center">
                        ...
                        Teacher Name : <?php // $result[0]['teacher_name']; ?>
                                ...
                                <div class="col-xs-12 table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $teacher->co_name;?></td>
                                            <td><?= $teacher->su_name;?></td>
                                            <?php 
                                                $payment =  '0.' . $teacher->comission;
                                                $payment =  $payment * $teacher->std_paid;
                                            ?>
                                            <td><?= $payment;$total_remaning += $payment?></td>
                                        </tr>
                                        <?php 
                                                $i++;
                                            } 
