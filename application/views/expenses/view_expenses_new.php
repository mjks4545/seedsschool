                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <a href="<?= site_url() ?>expenses/addexpenses" type="button"
                           class="print_class btn btn-success pull-right"><i class="glyphicon glyphicon-plus"></i>&nbsp;&nbsp;&nbsp;Add&nbsp;&nbsp;Expenses</a>
                       ...
                       <div class="">
                        <table class="table table-bordered">
                            <tr class="text-center">
                                <h4 class="text-center" style="padding:10px; ">Daily Expenses of <?php echo $months.'-'.$years; ?></h4>
                            </tr>
                            <thead>
                            <tr style="background:#888888; color:#FFF;">
                               <td></td>
                                <?php // start date of the month
                                $start_date =  '01-'.$months.'-'.$years;
                                //  end date of the month
                                $end_date = date("d-M-Y", strtotime('-1 second',strtotime('+1 month',strtotime( $start_date ))));
