                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-xs-6">
                      ...
                      <div class="small-box bg-aqua">
                        ...
                        <a href="<?= site_url()?>reports/monthlyvisitors" class="small-box-footer">
                   ...
                   <div class="col-lg-3 col-xs-6">
                      ...
                      <div class="small-box bg-green">
                        ...
                        <div class="icon">
                          ...
                          <a href="<?= site_url()?>reports/monthlystudents" class="small-box-footer">
                          Click here  <i class="fa fa-arrow-circle-right"></i>
                        </a>
                      </div>
                    </div><!-- ./col -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-xs-6">
                      ...
                      <div class="small-box bg-green">
                        ...
                        <a href="<?= site_url()?>reports/monthly_teacherwisestudent" class="small-box-footer">
                          Click here  <i class="fa fa-arrow-circle-right"></i>
                        </a>
                      </div>
                    </div><!-- ./col -->
